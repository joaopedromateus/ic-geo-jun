...
var lyr_Andorinha_modificado_5 = new ol.layer.Image({
                            opacity: 1,
                            title: "Andorinha_modificado",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/Andorinha_modificado_5.png",
    attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-4458953.529507, -1190492.186845, -4392135.017743, -1113322.667307]
                            })
                        });

lyr_GoogleSatellite_0.setVisible(true);lyr_HD_MASSA_DAGUA_1.setVisible(true);lyr_HD_MID_CURSO_DAGUA_2.setVisible(true);lyr_LM_UF_3.setVisible(true);lyr_LM_MUNICIPIO_2007_4.setVisible(true);lyr_Andorinha_modificado_5.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_HD_MASSA_DAGUA_1,lyr_HD_MID_CURSO_DAGUA_2,lyr_LM_UF_3,lyr_LM_MUNICIPIO_2007_4,lyr_Andorinha_modificado_5];
