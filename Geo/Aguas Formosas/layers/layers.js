...
var lyr_AguasFormosas_modificado_5 = new ol.layer.Image({
                            opacity: 1,
                            title: "Aguas Formosas_modificado",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/AguasFormosas_modificado_5.png",
    attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-4566661.360463, -1994429.018742, -4506377.951843, -1913595.769288]
                            })
                        });

lyr_GoogleSatellite_0.setVisible(true);lyr_HD_MASSA_DAGUA_1.setVisible(true);lyr_HD_MID_CURSO_DAGUA_2.setVisible(true);lyr_LM_UF_3.setVisible(true);lyr_LM_MUNICIPIO_2007_4.setVisible(true);lyr_AguasFormosas_modificado_5.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_HD_MASSA_DAGUA_1,lyr_HD_MID_CURSO_DAGUA_2,lyr_LM_UF_3,lyr_LM_MUNICIPIO_2007_4,lyr_AguasFormosas_modificado_5];
