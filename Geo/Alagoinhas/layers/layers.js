...
var lyr_AlagoinhasSD24XAII_modificado_5 = new ol.layer.Image({
                            opacity: 1,
                            title: "Alagoinhas - SD-24-X-A-II",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/AlagoinhasSD24XAII_modificado_5.png",
    attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-4290776.193057, -1416034.614427, -4223956.734082, -1340648.293276]
                            })
                        });

lyr_GoogleSatellite_0.setVisible(true);lyr_HD_MASSA_DAGUA_1.setVisible(true);lyr_HD_MID_CURSO_DAGUA_2.setVisible(true);lyr_LM_UF_3.setVisible(true);lyr_LM_MUNICIPIO_2007_4.setVisible(true);lyr_AlagoinhasSD24XAII_modificado_5.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_HD_MASSA_DAGUA_1,lyr_HD_MID_CURSO_DAGUA_2,lyr_LM_UF_3,lyr_LM_MUNICIPIO_2007_4,lyr_AlagoinhasSD24XAII_modificado_5];
