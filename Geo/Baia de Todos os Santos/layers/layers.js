...
var lyr_BaadeTodososSantosSD24XAIV_modificado_5 = new ol.layer.Image({
                            opacity: 1,
                            title: "Baía de Todos os Santos - SD-24-X-A-IV",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/BaadeTodososSantosSD24XAIV_modificado_5.png",
    attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-4345459.846394, -1473804.624670, -4278629.195423, -1397204.697530]
                            })
                        });

lyr_GoogleSatellite_0.setVisible(true);lyr_HD_MASSA_DAGUA_1.setVisible(true);lyr_HD_MID_CURSO_DAGUA_2.setVisible(true);lyr_LM_UF_3.setVisible(true);lyr_LM_MUNICIPIO_2007_4.setVisible(true);lyr_BaadeTodososSantosSD24XAIV_modificado_5.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_HD_MASSA_DAGUA_1,lyr_HD_MID_CURSO_DAGUA_2,lyr_LM_UF_3,lyr_LM_MUNICIPIO_2007_4,lyr_BaadeTodososSantosSD24XAIV_modificado_5];
